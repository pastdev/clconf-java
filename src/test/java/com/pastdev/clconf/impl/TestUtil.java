...
public class TestUtil {
    ...
    /**
     * Asserts that the maps are equivalent. A recursive comparison is made using a depth first
     * traversal.
     * 
     * @param expected
     *            The expected value
     ...
     *            The actual value
     */
    public static void assertDeepEquals( Map<String, Object> expected,
    ...
    /**
     * Asserts that the yaml strings are equivalent. Each string will be loaded into a java object
     * and then compared.
     * 
     * @param expectedYaml
     *            The expected value
    ...
    public static void assertYamlEquals( String expectedYaml, String actualYaml ) {
        ...
        if ( expected instanceof Map ) {
            ...
            assertTrue( "expected list, got " + actual.getClass().getName(),
