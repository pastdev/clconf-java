...
public class TestUtil {
	...
	public static void assertDeepEquals(Map<String, Object> expected, Map<String, Object> actual, String base) {
	    ...
	    for (String key : expected.keySet()) {
	    	...
	    	if (expectedValue instanceof Map) {
	    		if (actualValue instanceof Map) {
	    			assertDeepEquals(castMap(expectedValue), castMap(actualValue), base + "/" + key);
	    		}
	    		else {
