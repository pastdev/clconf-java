...
public class DefaultClconf implements Clconf {
    ...
    @Override
    public <T> T getValue( Map<String, Object> configuration, String path, T defaultValue ) {
        Object value;
        try {
            value = getValue( configuration, path );
        }
    ...
    @Override
    public Map<String, Object> loadConfigurationFromEnvironment( String[] files,
            String[] overrides )
            throws IOException {
